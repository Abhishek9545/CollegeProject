...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
           ...
           <input type="Mobile / Email" class="form-control" placeholder="Mobile / Email" valu="email" requierd>
            ...
            <a href="User_Registration.jsp"><b><u>Create an Account</u></b></a>
            </div>
